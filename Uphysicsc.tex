...
\subsection{Payload time opt}

\subsection{The logarithmic spiral trajectory}
Literature suggests \liter{tsu} one can neglect the  $\dot{v}_r$ term in equation !!! as a first approach. The simplified equation reads
\begin{equation}
