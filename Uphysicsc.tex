...
\begin{itemize}
\item Spacecraft mass is properly distributed between payload and solar sail mass. Moreover this distribution leads to a reasonable flight time.
\item Results are obtained not only for aproximations but also for exact expressions of motion equations. Calculations allow one to visualize trajectories followed by the craft.
